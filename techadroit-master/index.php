                ...
                <div class="col-lg-12">
                    <form name="sentMessage" id="registerForm" method="post" novalidate>
                        <div class="row">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="form-group">
                                    <input type="text" name="college" class="form-control" placeholder="Your College/School *" id="college" required data-validation-required-message="Please enter your College/School.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6 text-center">
                                <div class="form-group">
                                    <input type="text" name="gender" class="form-control" placeholder="Gender *" id="gender" required data-validation-required-message="Please enter your gneder.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6 text-center">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="form-group">
                                    <input type="password" name="password" class="form-control" placeholder="Password *" id="password" required data-validation-required-message="Please enter your Year/Class.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
                                <input type="submit" name="submit" class="btn btn-xl" value="Sign Up"></input>
                            </div>
                        </div>
                    </form>
                </div>
